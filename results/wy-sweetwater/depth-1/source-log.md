...
| Exact candidate AOI map is still missing, but the first GR-2/GR-1 exact-geometry overlay table is complete with BLM-only acreage, ACEC, NFHL, and public WGFD sage-grouse polygon clips. | `corridor-aoi-overlay-table-2026-06-20.md` | 2026-06-20 | Gap finding + table artifact | open | RMP/lek/NWI/transmission overlays are clipped against the ranked parcel blocks with true acreage outputs. |
